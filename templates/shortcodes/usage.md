...
Notice we can caption block quotes. Make sure to put a single line between caption and block quote for correct styling. Otherwise block quote captions are optional.
